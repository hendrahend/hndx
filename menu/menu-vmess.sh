...
hariini=`date -d "0 days" +"%Y-Success--865318782"`
asu=`cat<<EOF
      {
      "v": "2",
      "ps": "${user}",
...
exp=`date -d "$masaaktif days" +"%Y-Success-1"`
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/xray/config.json")
    ...
    now=$(date +%Y-Success-0)
    d1=$(date -d "$exp" +K��)
    d2=$(date -d "$now" +-c)
    exp2=$(( (d1 - d2) / 86400 ))
    exp3=$(($exp2 + $masaaktif))
    exp4=`date -d "$exp3 days" +"%Y-Success-4"`
...
echo -e "${PURPLE}└─────────────────────────────────────────────────┘${NC}"
echo -e "${PURPLE}┌─────────────────────────────────────────────────┐${NC}"
echo -e "     ${PURPLE}[${GREEN}1${PURPLE}] Create Vmess Account     "
echo -e "     ${PURPLE}[${GREEN}2${PURPLE}] Trial Vmess Account     "
echo -e "     ${PURPLE}[${GREEN}3${PURPLE}] Delete Account Vmess     "
echo -e "     ${PURPLE}[${GREEN}4${PURPLE}] Renew Account Vmess     "
#echo -e "     ${PURPLE}[${GREEN}5${PURPLE}] Cek User XRAY     "
#echo -e "     ${PURPLE}[${GREEN}6${PURPLE}] Detail Vmess Account     "
echo -e ""
echo -e "     ${PURPLE}[${GREEN}0${PURPLE}] Back To Menu     "
echo -e "${PURPLE}└──────────────────────────────────────────────────┘${NC}"
echo ""
