...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/hendra-hendriana/hndx-autoscript/main/config/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/hendra-hendriana/hndx-autoscript/main/config/vps.conf"
# Install Xray #
...
EOF
echo -e "${OKAY} Enable & Start & Restart & Xray"
systemctl daemon-reload >/dev/null 2>&1
systemctl enable xray >/dev/null 2>&1
systemctl start xray >/dev/null 2>&1
systemctl restart xray >/dev/null 2>&1
echo -e "${OKAY} Enable & Start & Restart & Nginx"
systemctl daemon-reload >/dev/null 2>&1
...
sleep 1
echo -e "${OKAY} Restart & Xray & Nginx"
systemctl daemon-reload >/dev/null 2>&1
systemctl restart xray >/dev/null 2>&1
systemctl restart nginx >/dev/null 2>&1
